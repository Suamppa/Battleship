...
- Gameplay, sadly
- Can't quit the game
- Number of ships is not implemented yet
- Quantity counter is not implemented yet
...
What was learned:
- A ton about the ins and outs of UI in Unity
- A lot more familiarity with Unity's event system
- Adapting UI to different screen sizes
	- The game board and the ship selection screen may be prone to errors in this regard in the returned state
